...
function onConnect() {
	if(localStorage.getItem("userType") == "FRIEND")
		var topic = "UploadPhoto";
	else
		var topic = "CurrentPhoto";
...
function onMessageArrived(message) {
    ...
    if(message.destinationName == "CurrentPhoto"){
    	var photoFrame = document.getElementsByClassName("photo-carousel")[0];
    	photoFrame.innerHTML = "<div><img class='carousel-img' src='resources/photo/" + message.payloadString + "'></div>";
    } 
    updateScroll();
}
